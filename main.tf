...
# Configure routes provided in the input variable `subnets` into the public subnet.
...
# Configure routes provided in the input variable `subnets` into the private subnets.
